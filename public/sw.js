if (!self.define) {
  let n,
    s = {};
  const c = (c, e) => (
    (c = new URL(c + ".js", e).href),
    s[c] ||
      new Promise((s) => {
        if ("document" in self) {
          const n = document.createElement("script");
          ((n.src = c), (n.onload = s), document.head.appendChild(n));
        } else ((n = c), importScripts(c), s());
      }).then(() => {
        let n = s[c];
        if (!n) throw new Error(`Module ${c} didn’t register its module`);
        return n;
      })
  );
  self.define = (e, a) => {
    ...
    let t = {};
    const l = (n) => c(n, i),
      r = { module: { uri: i }, exports: t, require: l };
    s[i] = Promise.all(e.map((n) => r[n] || l(n))).then((n) => (a(...n), t));
  };
}
define(["./workbox-cb477421"], function (n) {
  "use strict";
  (importScripts(),
    self.skipWaiting(),
    n.clientsClaim(),
      ...
      [
        {
          ...
          revision: "18442fc1e501c6aed548c9abf2ccf721",
        },
        {
          url: "/_next/static/JMl9Xs9PKYUn_nRWcv1vp/_buildManifest.js",
          revision: "6310079bf1ae7bebeb6a2135896e4564",
        },
        {
          url: "/_next/static/JMl9Xs9PKYUn_nRWcv1vp/_ssgManifest.js",
          revision: "b6652df95db52feb4daf4eca35380933",
        },
        {
          url: "/_next/static/chunks/1199-81f4a1cd04ba6006.js",
          revision: "JMl9Xs9PKYUn_nRWcv1vp",
        },
        {
        ...
        {
          url: "/_next/static/chunks/webpack-b5ca782504c7142b.js",
          revision: "JMl9Xs9PKYUn_nRWcv1vp",
        },
        {
    ...
    n.registerRoute(
      ...
      new n.NetworkFirst({
        ...
        plugins: [
          new n.ExpirationPlugin({ maxEntries: 200, maxAgeSeconds: 86400 }),
        ],
      }),
      "GET",
    ));
