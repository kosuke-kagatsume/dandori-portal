if (!self.define) {
  let n,
    c = {};
  const e = (e, s) => (
    (e = new URL(e + ".js", s).href),
    c[e] ||
      new Promise((c) => {
        if ("document" in self) {
          const n = document.createElement("script");
          ((n.src = e), (n.onload = c), document.head.appendChild(n));
        } else ((n = e), importScripts(e), c());
      }).then(() => {
        let n = c[e];
  ...
  self.define = (s, a) => {
    ...
    c[i] = Promise.all(s.map((n) => r[n] || u(n))).then((n) => (a(...n), t));
  };
}
      ...
      [
        {
          ...
          revision: "c910f6a5c2cbf81db7bcc21b09a92caf",
        },
        {
          url: "/_next/static/5HD6k1YKdcnwOSAZnKDuO/_buildManifest.js",
          revision: "6310079bf1ae7bebeb6a2135896e4564",
        },
        {
          url: "/_next/static/5HD6k1YKdcnwOSAZnKDuO/_ssgManifest.js",
          revision: "b6652df95db52feb4daf4eca35380933",
        },
        {
          url: "/_next/static/chunks/1199-81f4a1cd04ba6006.js",
          revision: "5HD6k1YKdcnwOSAZnKDuO",
        },
        {
        ...
        {
          url: "/_next/static/chunks/main-8ae4fdc8a77c0a6b.js",
          revision: "5HD6k1YKdcnwOSAZnKDuO",
        },
        {
        ...
        {
          url: "/_next/static/chunks/webpack-80e0fc3220646764.js",
          revision: "5HD6k1YKdcnwOSAZnKDuO",
        },
        {
