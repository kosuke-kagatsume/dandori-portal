...
export function getUserInviteEmail(params: UserInviteEmailParams): {
  subject: string;
  html: string;
  text: string;
} {
  const { tenantName, userName, email, password, loginUrl } = params;
...
<body>
  <div class="container">
    ...
    <p>${tenantName} のDandori Portalへようこそ。</p>
